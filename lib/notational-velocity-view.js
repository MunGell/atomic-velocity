...
class NotationalVelocityView extends SelectListView {
    ...
    selectItem(filteredItems, filterQuery) {
        var editor, isCursorProceeded, item, j, k, len, len1, n, results;
    ...
    confirmSelection() {
        var calculatedPath, filePath, item, sanitizedQuery;
...
export default NotationalVelocityView;
